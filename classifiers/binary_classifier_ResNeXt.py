...
class IHCClassifier(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.resnext = models.resnext50_32x4d(pretrained=True)  # Using ResNeXt-50
        num_ftrs = self.resnext.fc.in_features
        self.resnext.fc = nn.Linear(num_ftrs, num_classes)  # Replace the classifier
...
def train(model, dataloader, optimizer, criterion, device):
    ...
    torch.save(model, "./saved_models/resnext50_32x4d")
